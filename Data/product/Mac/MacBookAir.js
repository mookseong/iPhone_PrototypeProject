...
const MacbookAirList = function () {
    const MacBook_Air_Performance =
        new ProductPerformance().setCPU('M1 7GPU').setRAM('8G').setScreenSize(13).setStorage(256).build()
    const MacBook_Air_high_Performance =
        new ProductPerformance().setCPU('M1 8GPU').setRAM('8G').setScreenSize(13).setStorage(512).build()
    this.MacBook_Air =
